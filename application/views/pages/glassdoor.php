...
<div class="container">
	...
	<input type="hidden" class="for_link" name="for_link" value="gb_r">

	<h4 class="comp">Glassdoor Rating</h4>
	<div class="stars">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(document).on('click','.submitmodalbtn',function() {
			...
			var name= $('.name').val();
			var tbl_name= 'glassdoor_ratings';
			var form_key= $('.form_key').val();
				...
				success: function(data){
					...
					if (starv <= 3) {
						...
						if (data.gd == "") {
							...
							window.location.assign(data.gd);
						}
					}
				},
				error: function(){
