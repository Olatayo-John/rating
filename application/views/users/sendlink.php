	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-check">
				...
				<label class="form-check-label" for="ow">Rating Link</label>
			</div>
			...
			<div class="sndasbtngrp mt-2">
				...
				<span class="text-light font-weight-bolder ml-2 mr-2">OR</span>
			...
			<form action="<?php echo base_url('user/sendlink'); ?>" method="post" id="gen_link_form" class="gen_link_form">
				...
				<div class="import text-right d-flex justify-content-between mb-4">
					...
					<div class="sendlinkdiv">
						<button class="btn btn-success sendlinkbtn"><i class="fas fa-envelope mr-2"></i>Send Email</button>
						<button class="btn btn-success sendmultiplelinkbtn" style="display: none;">
					...
					<form action="<?php echo base_url('user/sms_send_link'); ?>" method="post" id="sms_gen_link_form" class="sms_gen_link_form">
						...
						<div class="sms_import text-right d-flex justify-content-between mb-4">
							...
							<div class="sendlinkdiv">
								<button class="btn btn-success smssendlinkbtn"><i class="fas fa-comment-dots mr-2"></i>Send SMS</button>
								<button class="btn btn-success smssendmultiplelinkbtn" style="display: none;">
