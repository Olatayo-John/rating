...
<div class="container mt-5">
			...
			<div class="modal-content">
				<form enctype="multipart/form-data" method="post" id="upload_csv">
					...
					<div class="modal-footer justify-content-between">
						...
						<button class="btn text-light importbtn" type="submit" style="background-color:#00695C">Import</button>
					</div>
				</form>
			</div>
		</div>
			...
			<div class="modal-content">
				<form enctype="multipart/form-data" method="post" id="smsupload_csv">
					...
					<div class="modal-footer justify-content-between">
						...
						<button class="btn text-light smsimportbtn" type="submit" style="background-color:#00695C">Import</button>
					</div>
				</form>
			</div>
		</div>
	...
	<div class="col-md-12 d-flex sndasbtngrp mb-5">
		<div class="col text-center">
			<button class="sndasmailbtn btn btn-outline-info btn-block">Send as Email</button>
		</div>
		<div class="col text-center">
			<button class="sndassmsbtn btn btn-outline-warning btn-block">Send as SMS</button>
		</div>
	</div>

	<div class="col-md-12 allform">
		<form action="<?php echo base_url('user/sendlink'); ?>" method="post" id="gen_link_form" class="gen_link_form">
			...
			<div class="import text-right d-flex justify-content-between mb-4">
				<button class="btn text-light singlemailsend" type="button" style="display: none;background-color:#00695C">Send single mail</button>
				<input type="hidden" name="link_for" class="link_for">
				<button class="btn text-light importemail" type="button" style="background-color:#00695C">Import emails in CSV format</button>
				...
				<div class="form-group">
					<label style="color: #fff">Body</label>
					<textarea class="form-control bdy" rows="8" name="bdy"></textarea>
				</div>
				<div class="sendlinkdiv">
					<button class="btn sendlinkbtn text-light" style="background-color:#00695C"><i class="fas fa-envelope mr-2"></i>Send Email</button>
					<button class="btn sendmultiplelinkbtn text-light" style="display: none;background-color:#00695C">
				...
				<form action="<?php echo base_url('user/sms_send_link'); ?>" method="post" id="sms_gen_link_form" class="sms_gen_link_form">
					...
					<div class="sms_import text-right d-flex justify-content-between mb-4">
						<button class="btn text-light singlsmssend" type="button" style="display: none;background-color:#00695C">Send single sms</button>
						<input type="hidden" name="link_for" class="link_for">
						<button class="btn text-light smsimport" type="button" style="background-color:#00695C">Import Phonenumber in CSV format</button>
						<a href="<?php echo base_url('user/sms_sample_csv'); ?>" class="email_sample_csv btn btn-danger">
							<i class="fas fa-file-csv mr-2"></i>Download sample csv</a>
						</div>
						<div class=" form-group">
							<label style="color: #fff">Phonenumber:</label>
						...
						<div class="sendlinkdiv">
							<button class="btn text-light smssendlinkbtn" style="background-color:#00695C"><i class="fas fa-comment-dots mr-2"></i>Send SMS</button>
							<button class="btn text-light smssendmultiplelinkbtn" style="display: none;background-color:#00695C">
