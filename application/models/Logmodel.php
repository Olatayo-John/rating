...
class Logmodel extends CI_Model
{
    ...
    // $e=Error {any Error to be passed...};
    public function log_act($type, $e = null)
    {
        switch ($type) {
            case 'logout':
                $msg = "Logged Out [ ID: " . $this->session->userdata('mr_id') . ", Username: " . $this->session->userdata('mr_uname') . " ]";
                break;
            case 'new_user_verify_mail_err':
                $msg = "Error sending verfication email for New User [ Username: " . htmlentities($this->input->post('uname')) . ", Email: " . htmlentities($this->input->post('email')) . ", MailError: " . $e . " ]";
                break;
            case 'newuser':
                $msg = "New user registration - Verification code sent to email [ Username: " . htmlentities($this->input->post('uname')) . ", Email: " . htmlentities($this->input->post('email')) . " ]";
                break;
            case 'acct_verify':
                $msg = "User account verified [ ID: " . $this->session->userdata('mr_id') . ", Username: " . $this->session->userdata('mr_uname') . " ]";
                break;
                case 'acct_verify_err':
                    $msg = "Error verifying user account [ ID: " . $this->session->userdata('mr_id') . ", Username: " . $this->session->userdata('mr_uname') . " ]";
                    break;
            case 'true_login':
                $msg = "Logged In [ ID: " . $this->session->userdata('mr_id') . ", Username: " . $this->session->userdata('mr_uname') . " ]";
                break;
            case 'false_login':
                $msg = "Failed Login Attempt - Wrong Credentials [ Username: " . htmlentities($this->input->post('uname')) . " ]";
                break;
            case 'inactive_access':
                $msg = "Failed Login Attempt - Inactive Access [ Username: " . htmlentities($this->input->post('uname')) . " ]";
                break;
            case 'inactive_account':
                $msg = "Failed Login Attempt - Inactive Account [ Username: " . htmlentities($this->input->post('uname')) . " ]";
                break;
            case 'db_err':
                $msg = "Error saving to Database - " . $e . "";
                break;
            case 'smail_sent':
            ...
            case 'webnewerr':
                ...
                break;
            case 'websitenew':
                $msg = "New Websites created | User | [ ID: " . $this->session->userdata('mr_id') . ", WebName: " . htmlentities($_POST['web_name']) . ", WebLink: " . htmlentities($_POST['web_link']) . " ]";
                break;
            case 'websitenewerr':
                $msg = "Error creating new Website | User | [ ID: " . $this->session->userdata('mr_id') . ", Web: " . htmlentities($_POST['web_name']) . ", WebLink: " . htmlentities($_POST['web_link']) . " ]";
                break;
            case 'webnew':
                ...
                break;
            case 'webdelerr':
                $msg = "Error deleting Website | User | [ ID: " . $this->session->userdata('mr_id') . ", WebID: " . $_POST['web_id'] .  " ]";
                break;
            case 'webdel':
                $msg = "Website deleted | User | [ ID: " . $this->session->userdata('mr_id') . ", WebID: " . $_POST['web_id'] . " ]";
                break;
            case 'prfileerr':
