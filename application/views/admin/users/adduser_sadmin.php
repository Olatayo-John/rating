...
<div class="adduserDiv">
	<div class="p-3 bg-light-custom">
		<form action="<?php echo base_url('sadmin-add-user'); ?>" method="post" id="sadminAddUserForm">
			...
			<div class="form-group font-weight-bolder text-left d-flex">
				...
				<input type="checkbox" name="logincred" class="logincred" id="logincred" style="margin: auto 0 auto 3px;" checked>
			</div>
