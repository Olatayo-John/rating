...
class Logmodel extends CI_Model
{
    ...
    // $m=Module {User,Admin};
    // $e=Error {Mail Error...};
    public function log_act($type, $m=null, $e = null)
    {
        switch ($type) {
            case 'logout':
                $msg = "Logged Out. [ID: " . $this->session->userdata('mr_id') . ", Name: " . $this->session->userdata('mr_uname') . "]";
                break;
            case 'newUser_verify_mail_err':
                $msg = "Failed to send Verfication email for New User| ".$m." | [UserName: " . htmlentities($this->input->post('uname')) . ", Email: " . htmlentities($this->input->post('email;')) . ", MailError: " . $e . "]";
                break;
            case 'newuser':
                ...
                break;
            case 'acctverified':
                $msg = "User account activated and logged in | User | [ID: " . $this->session->userdata('mr_id') . ", UserName: " . $this->session->userdata('mr_uname') . "]";
                break;
            case 'login':
