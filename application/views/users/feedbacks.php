...
<div class="mt-3 mr-3 ml-3">
	<div class="bg-light table-responsive">
		<div class="pt-3 pb-3 pl-3">
			<a href="<?php echo base_url("user/export_feedbacks") ?>" class="btn text-light" style="background: #141E30;border-radius: 0">
				<i class="fas fa-file-csv mr-2"></i>CSV Download
			</a>
		</div>
		<table class="table">
			<tr class="text-center text-light" style="background: #141E30">
				<th>ID</th>
				<th>Name</th>
				<th>E-mail</th>
				<th>Message</th>
