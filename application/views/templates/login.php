...
<div class="loginbox container col-md-5">
	<form action="<?php echo base_url('login'); ?>" method="post" id="loginForm" class="">
		...
		<div class="signup">
			<a href="<?php echo base_url('register'); ?>" class="signupbtn text-danger">
				Create Account
