<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/platforms.css'); ?>">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url("user/add_website") ?>" class="add_web_modal_form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="web_name" class="web_name form-control" placeholder="Platform Name" required>
                        </div>
            ...
            <?php foreach ($webs->result_array() as $web) : ?>
                <div class="d-flex flex-direction-row col-md-12 p-0 eachwebinfo">
                    <div class="form-group" style="margin:0">
                        <span class="text-success"><i class="fas fa-circle" title="Platform is active"></i></span>
                    </div>
